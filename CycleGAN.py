...
class CycleGAN:
    def __init__(self, generator_g, generator_f, discriminator_x, discriminator_y, batch_size, epochs, filepath, checkpoint=None, train_steps=None,
                 val_steps=None, LAMBDA_g=.001, LAMBDA_f=.01): # MimickNet used lambda that was 10x higher than the lambda = 100 used in the cGAN pix2pix paper
        ...
        self.generator_g_optimizer = tf.keras.optimizers.Adam(2e-4, beta_1=0.5, beta_2=.99)
        self.generator_f_optimizer = tf.keras.optimizers.Adam(2e-4, beta_1=0.5, beta_2=.99)

        self.discriminator_x_optimizer = tf.keras.optimizers.Adam(2e-4, beta_1=0.5, beta_2=.99)
        self.discriminator_y_optimizer = tf.keras.optimizers.Adam(2e-4, beta_1=0.5, beta_2=.99)
